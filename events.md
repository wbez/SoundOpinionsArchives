...
##3/10/2020 *Separating the Art and the Artist. Can we? Should we?*

Join Sound Opinions hosts {host: Jim DeRogatis} and {host: Greg Kot} and producer {name: Ayana Contreras} as they lead a dialogue on this important topic with audience Q&A on Tuesday, March 10 at 7:00 p.m. in the {place: Hammerschmidt Memorial Chapel}, Elmhurst College (190 S. Prospect Avenue). The event is open to public, however, [a reservation is required](https://elmhurstpubliclibrary.evanced.info/signup/EventDetails?EventId=32561&backTo=Calendar&startDate=2020/03/01).
